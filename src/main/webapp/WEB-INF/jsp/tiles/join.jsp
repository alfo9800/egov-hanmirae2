				...
				<fieldset>
					...
					<ul class="app_list">
						...
						<li class="clear">
							...
							<div class="app_content"><input type="text" name="PASSWORD_CNSR" class="w100p" id="password_cnsr" placeholder="비밀번호 힌트 답변을 입력해주세요" required/></div>
						</li>
						<li class="clear">
							<label for="user_nm_lbl" class="tit_lbl pilsoo_item">이름</label>
							<div class="app_content"><input type="text" name="USER_NM" class="w100p" id="user_nm" placeholder="이름을 입력해주세요" required/></div>
						</li>
						<li class="clear">
						...
						<li class="clear">
							...
							<div class="app_content"><input type="email" name="EMAIL_ADRES" class="w100p" id="email_adres" placeholder="이메일을 입력해주세요" required/></div>
						</li>
						<li class="clear">
							<label for="house_adres_lbl" class="tit_lbl pilsoo_item">집 주소</label>
							<div class="app_content"><input type="text" name="HOUSE_ADRES" class="w100p" id="house_adres" placeholder="집 주소를 입력해주세요" required/></div>
						</li>		
						<li class="clear">
